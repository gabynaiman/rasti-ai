...
describe Rasti::AI::LLM::OpenAI::Client do

  let(:api_url) { 'https://api.openai.com/v1/chat/completions' }

  def user_message(content)
    {
      role: Rasti::AI::Roles.user,
      content: content
    }
  end
  ...
  describe 'Basic message' do
    ...
    it 'Default API key, model and logger' do
      ...
      client = Rasti::AI::LLM::OpenAI::Client.new
    ...
    it 'Custom API key' do
      ...
      client = Rasti::AI::LLM::OpenAI::Client.new api_key: custom_api_key
    ...
    it 'Custom logger' do
      ...
      client = Rasti::AI::LLM::OpenAI::Client.new logger: logger
